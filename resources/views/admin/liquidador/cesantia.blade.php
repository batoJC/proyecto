    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            <h3 class="text-center">
                Selecciona la fecha de inicio y un consecuivo para generar las cesantias
            </h3>
            <br>
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col text-center">
                    <br>
                    <button type="button" onclick="cargarCesantias()" class="btn btn-success">Generar cesantías <i class="fa fa-spinner"></i></button>
                </div>
            </div>
            
            <br>
            <div id="tabla_cesantia">
