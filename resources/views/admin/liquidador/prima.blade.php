    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            <h3 class="text-center">
                Selecciona la fecha de inicio y un consecutivo para liquidar prima hasta la última liquidación
            </h3>
            <br>
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4 text-center">
                    ...
                    <button type="button" onclick="cargarPrima()" class="btn btn-success"> Generar prima <i class="fa fa-spinner"></i></button>
                </div>
            </div>
            <br>
            <div id="tabla_prima">
