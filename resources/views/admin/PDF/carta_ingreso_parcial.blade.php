 <html>
    ...
    <body>
        ...
        <main>
            ...
            <p>Les manifiesto que el propietario del {{ $carta->unidad->tipo->nombre }} {{ $carta->unidad->numero_letra }} permite el ingrso de las siguientes bienes y personas quienes son las autorizadas para ingresar a dicho {{ $carta->unidad->tipo->nombre }}.</p>
            ...
            <p>Por lo anterior están autorizadas para efectuar trasteo de bienes de los inquilinos, parcial hasta el día @php
                $fecha = $carta->fecha;
